...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function (selector) {
  ...
  for (let i = 0; i < this.length; i++) {
    let result = this[i].closest(selector); // мое условие, чтобы не было null, но все же что-то записывалось
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttr = function (attrNames, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttr = function (attrNames, value) {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].hasAttribute(attrNames)) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleAttr = function (attrNames) {
  for (let i = 0; i < this.length; i++) {
    if (this[i].hasAttribute(attrNames)) {
      this[i].removeAttribute(attrNames);
    } else {
...
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])(".some").closest(".findmeq")); //console.log($(".findme").siblings());
